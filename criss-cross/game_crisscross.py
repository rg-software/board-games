...
class Game:
    ...
    def is_game_over(self):
        return self.round == 12 or not self.has_vacant_place()
    ...
    def line_score(self, r, c, dr, dc, char):
        flag = False
        s = 0
        result = []
        for _ in range(5):
    ...
    def card_score(self):
        ...
        for char in range(1, 7):
            for r in range(5):
                s.extend(self.line_score(r, 0, 0, 1, char))
                s.extend(self.line_score(0, r, 1, 0, char))
